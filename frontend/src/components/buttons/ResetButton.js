...
/**
 *This component class is for the reset button
 * that resets everything to GRW-2012 settings.
 *
 * @class ResetButton
 * @extends {Component}
 */
class ResetButton extends Component {
    /**
     *This function is the called by pressing the button.
     *
    ...
    handleButtonReset = () => {
      this.handleButtonResetProm().then(() => {
        ...
        document.getElementById('var_name_0').value =
        'Arbeitslosenquote auf alle Erwerbspersonen ORIGINA_200';
        document.getElementById('var_name_1').value =
        'Lohn pro Beschäftigtem 2010 _ORIGINAL_200';
        document.getElementById('var_name_2').value =
        'Erwerbstätigenprognose _ORIGINAL_200';
        document.getElementById('var_name_3').value =
        'Infrastrukturindikator_ORIGINAL_200';
        ...
        document.getElementById('ref_name_0').value =
        'Zivile Erwerbspersonen_100';
        document.getElementById('ref_name_1').value =
        'SV-pflichtig Beschäftigte am Wohnort_100';
        document.getElementById('ref_name_2').value =
        'SV-pflichtig Beschäftigte am Wohnort_100';
        document.getElementById('ref_name_3').value =
        'SV-pflichtig Beschäftigte am Wohnort_100';
    ...
    /**
     *This is the fuction that is creating an promis for the reset button.
     *
     * @return {Promise} promise to change everything to default values
     * @memberof ResetButton
     */
      ...
      return (
        <div className="reset_tooltip">
          <span className="reset_tooltiptext">
                   setzt alle Parameter auf den "originalen"
                   GRW-Indikator von 2012 zurück
          </span>
