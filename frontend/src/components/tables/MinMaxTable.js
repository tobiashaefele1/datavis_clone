...
class MinMaxTable extends Component {
  ...
  /**
    ...
    * and updates thd this.values accordingly.
    *
    * @memberof MinMaxTable
    */
    checkData = () => {
      if (this.props.indicator_data.length >= 2
        && this.props.single_indic_data.length >= 2) {
    ...
    *
    * @param {Array} arr array where the min, max and avg needs to be found in.
    ...
    render() {
      return (
        <table className="table" id="table"
          ...
          <tbody>
            <tr>{this.checkData()}
              <td id="min_value" style={{textAlign: 'center'}}>
                {this.values[0]}
              </td>
              <td id="avg_value" style={{textAlign: 'center'}}>
                {this.values[2]}
              </td>
              <td id="max_value" style={{textAlign: 'center'}}>
                {this.values[1]}
              </td>
            </tr>
          </tbody>
