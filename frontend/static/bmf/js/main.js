...
const indikator1 = document.getElementById('indikator_1');
const indikator2 = document.getElementById('indikator_2');
const indikator3 = document.getElementById('indikator_3');
const indikator4 = document.getElementById('indikator_4');
const indikator5 = document.getElementById('indikator_5');
const indikator6 = document.getElementById('indikator_6');
const indikators = [indikator1, indikator2, indikator3, indikator4, indikator5, indikator6];

// TObias: variable transferred to ajax.js
// let indicator_count = 3;

let current_color_set = [];
...
function UpdateNumbers(data) {
  ...
  const minMaxAvg = FindMinMaxAvg(data_array);
