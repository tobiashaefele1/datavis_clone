...
from server.data.retrieve_db_data import retrieve_year_dict_from_db, retrieve_col_years, retrieve_metadata, \
...
def index(request):
    if request.method == "GET":
        ...
        col_names_var = clean_col_names(retrieve_col_names("kreise"))
