...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'frontend/static/frontend/main.js'),
    os.path.join(BASE_DIR, 'frontend/static/bmf/css/custom.css'),
os.path.join(BASE_DIR, 'frontend/static/bmf/css/map.css'),
os.path.join(BASE_DIR, 'frontend/static/bmf/css/style.css'),
os.path.join(BASE_DIR, 'frontend/static/bmf/fonts/BundesSansWeb-Bold.ttf'),
os.path.join(BASE_DIR, 'frontend/static/bmf/fonts/BundesSansWeb-Regular.ttf'),
os.path.join(BASE_DIR, 'frontend/static/bmf/js/jquery-3.4.1.min.js'),
os.path.join(BASE_DIR, 'frontend/static/bmf/resources/AMR12map.json'),
